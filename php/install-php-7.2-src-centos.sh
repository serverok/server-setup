...
mkdir /usr/local/src
cd /usr/local/src
wget http://php.net/get/php-7.2.1.tar.bz2/from/this/mirror -O php-7.2.1.tar.bz2
tar xf php-7.2.1.tar.bz2
cd /usr/local/src/php-7.2.1
make clean
./configure --prefix=/usr/serverok/php-7.2.1 \
--with-config-file-path=/usr/serverok/php-7.2.1/etc \
--with-pdo-mysql \
--with-mysqli \
--enable-cgi \
--with-zlib \
...
cp /usr/serverok/php-7.2.1/etc/php-fpm.conf.default /usr/serverok/php-7.2.1/etc/php-fpm.conf
cp /usr/serverok/php-7.2.1/etc/php-fpm.d/www.conf.default /usr/serverok/php-7.2.1/etc/php-fpm.d/www.conf
cp php.ini-development /usr/serverok/php-7.2.1/etc/php.ini
...
cd /usr/serverok/php-7.2.1/etc/

/usr/serverok/php-7.2.1/sbin/php-fpm
...
ExecStart=/usr/serverok/php-7.2.1/sbin/php-fpm --nodaemonize
...
vi /usr/serverok/php-7.2.1/etc/php-fpm.d/www.conf
